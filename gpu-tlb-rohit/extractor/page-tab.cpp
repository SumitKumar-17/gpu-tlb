 ...
 *
 ******************************************************************************/
PageTab::PageTab(MemDump &dump, std::uint64_t addr, TransType type, TransType page)
    : Trans(dump, addr, type), mPageType(page) {
}
 ...
 *
 ******************************************************************************/
void PageTab::printTrans(std::uint64_t virtAddr) {
