...
__device__ void branch(uint64_t src, uint64_t dst, uint64_t *ptr0, uint64_t *ptr1) {
    int64_t off = 0;
    uint64_t lo = 0;
    uint64_t hi = 0;
...
__global__ void loop(uint64_t *head, uint64_t *tail, volatile uint64_t *page1, uint64_t addr, uint64_t x) {
    int i = 0;
    uint64_t y = x;
...
__global__ void link(uint64_t *page_from, uint64_t *page_to) {
    uint64_t bra_lo = 0;
    uint64_t bra_hi = 0;
